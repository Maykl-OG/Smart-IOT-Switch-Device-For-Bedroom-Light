...
### Overview
This project implements an IoT-based Smart Switch using the ESP32 microcontroller. The system enables users to remotely control electrical devices (e.g., bedroom lights) through a local web server, eliminating the need to physically access the wall switch.
