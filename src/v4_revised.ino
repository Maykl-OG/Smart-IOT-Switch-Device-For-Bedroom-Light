    ...
    if (id >= 0 && id < 3) {
      if (cmd == "on") {
        ...
        if (id == 0) {
          ...
          myServos[id].write(70);  // <--- EDIT DERAJAT SAKELAR 3 (ON) DI SINI
        }
      } 
      else if (cmd == "off") {
        ...
        if (id == 0) {
          ...
          myServos[id].write(130); // <--- EDIT DERAJAT SAKELAR 3 (OFF) DI SINI
        }
      }
...
void setup() {
  ...
  for (int i = 0; i < 3; i++) {
    ...
    if (i == 0) {
      ...
      myServos[i].write(130); // <--- EDIT DERAJAT AWAL SAKELAR 3 DI SINI
    }
  }
