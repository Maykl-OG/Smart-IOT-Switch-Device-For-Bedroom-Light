...
<head>
  ...
  <style>
    ...
    .badge {
      ...
      font-weight: bold;
      margin-bottom: 20px;
      background: #555; /* Warna abu-abu saat baru dimuat */
      color: white;
...
<body>
  ...
  <div class="grid-container">
    <div>
      ...
      <div id="ind-0" class="badge">Siap</div>
    ...
    <div>
      ...
      <div id="ind-1" class="badge">Siap</div>
    ...
    <div>
      ...
      <div id="ind-2" class="badge">Siap</div>
      ...
      fetch(`/action?id=${id}&cmd=${state}`)
        .then(response => {
          if(response.ok) {
            ...
            // Mengubah Indikator Visual (Badge)
  ...
  if (server.hasArg("id") && server.hasArg("cmd")) {
    ...
    if (id >= 0 && id < 3) {
      if (cmd == "on") {
        ...
        myServos[id].write(180); 
        delay(400);              
        myServos[id].write(90);  
      } 
      else if (cmd == "off") {
